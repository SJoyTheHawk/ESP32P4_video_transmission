...
#include "ov5647_800x1280_registers.h"
...
const esp_cam_sensor_format_t &ov5647_800x1280_sensor_format() {
  ...
  static const esp_cam_sensor_format_t format = {
    ...
    .regs_size = sizeof(ov5647_mipi_2lane_24Minput_800x1280_raw8_50fps)
                 / sizeof(ov5647_mipi_2lane_24Minput_800x1280_raw8_50fps[0]),
    .fps = 50,
    .isp_info = &isp_info,
    .mipi_info = {
      .mipi_clk = 400000000,
